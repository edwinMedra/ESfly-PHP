        ...
        <div class="px-lg-5 py-lg-4 p-4 w-100 align-self-center">
          ...
          <form class="mb-2 g-0" method="post" enctype="multipart/form-data">
            <div class="mb-2 g-0">
              ...
              <input type="username" class="form-control" placeholder="Ingresa tu nombre" id="nombre" aria-describedby="emailHelp" name="nombre">
            </div>

            <div class="mb-2 ">
              <label for="exampleImputEmail" class="form-label font-weight-bold">
                <img src="../imagen/login/apellido.png" class="img"> Apellido</label>
              <input type="lastname" class="form-control mb-2" placeholder="Ingresa tu apellido" id="apellido" name="apellido">
            </div>
            ...
            <div class="mb-2">
              ...
              <input type="email" class="form-control mb-2" placeholder="Ingresa tu correo" id="correo" name="email">
            </div>

            <div class="mb-2">
              <label for="exampleImputEmail" class="form-label font-weight-bold">
                <img src="../imagen/login/pasaporte.png" class="img"> Pasaporte</label>
              <input type="text" class="form-control mb-2" placeholder="Ingresa tu pasaporte" id="pasaporte" name="passport">
            </div>

            <div class="mb-2">
              <label for="exampleImputEmail" class="form-label font-weight-bold">
                <img src="../imagen/login/dui.png" class="img"> DUI</label>
              <input type="text" class="form-control mb-2" placeholder="Ingresa tu dui" id="dui" name="dui">
            </div>
