...
<body>
  ...
  <div class="container-fluid my-5">
    ...
    <!--datos del check in-->
    <div class="row">
      <div class="col-12 col-sm-6 rounded-5 py-5 text-center" id="imagen1">
        <img src="../imagen/check-in/check.png" alt="" class="w-75">
        <p class="my-3"><b>Realiza tu Check-in</b></p>
        <button type="button" class="px-3 py-2" id="boton">CHECK-IN</button>
      </div>
      <div class="col-12 col-sm-6 rounded-5 p-5">
        <div class="info-box">
          <h3 class="text-center"><b>¿Qué es El check-in?
            <img src="../imagen/header/favicon.png" alt="Icono">
          </b></h3>
          <p>Es el proceso en el cual confirmas tu abordaje dentro de un vuelo. Ahí, la aerolínea con la que compraste tus boletos te dará tu pase de abordar y asignará el lugar que ocuparás en cabina, esto es para lo qué sirve el check-in. En pocas palabras, es tu confirmación como viajero.</p>
