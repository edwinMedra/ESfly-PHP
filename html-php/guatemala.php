...
<head>
    ...
    <link rel="stylesheet" href="../css/guatemala.css">
...
<body>
    ...
    <div class="back">
        <img src="../imagen/guatemala/back.avif" alt="">
        <div class="titulo">
            <p>Guatemala</p>
        </div>
    </div>
        ...
        <div class="horarios">
            <div class="padre">
                ...
                <div class="left">
                    ...
                    <div class="left-text"><p><b>DESTINO: </b> Guatemala ( Flores )</p></div>
                </div>
            </div>
...
<div class="img">
    <img src="../imagen/guatemala/flores.jpg" alt="">
</div>
    </div>
<!--Fin flores-->
<!--san pedro sula-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Guatemala (San Pedro Sula)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/guatemala/sula.jpg" alt="">
</div>
</div>
<!--Fin  sula-->
<!--quetzalcuando-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Guatemala (Quetzaltenango)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/guatemala/Quetzaltenango.webp" alt="">
</div>
</div>
<!--Fin quetzalcuango-->
    <!--pie de pagina web-->
