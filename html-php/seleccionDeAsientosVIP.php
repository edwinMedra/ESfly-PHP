        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="B2d">
              ...
              <input type="checkbox" id="B2d" name="B2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="B3d">
              ...
              <input type="checkbox" id="B3d" name="B3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="B4d">
              <button type="button" <?php validar($B4) ?> id="B4" onclick="toggleCheckbox('B4d')">B4</button>
              <input type="checkbox" id="B4d" name="B4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="B5d">
              <button type="button" <?php validar($B5) ?> id="B5" onclick="toggleCheckbox('B5d')">B5</button>
              <input type="checkbox" id="B5d" name="B5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="B6d">
              <button type="button" <?php validar($B6) ?> id="B6" onclick="toggleCheckbox('B6d')">B6</button>
              <input type="checkbox" id="B6d" name="B6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="C1d">
              ...
              <input type="checkbox" id="C1d" name="C1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="C2d">
              <button type="button" <?php validar($C2) ?> id="C2" onclick="toggleCheckbox('C2d')">C2</button>
              <input type="checkbox" id="C2d" name="C2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="C3d">
              ...
              <input type="checkbox" id="C3d" name="C3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="C4d">
              <button type="button" <?php validar($C4) ?> id="C4" onclick="toggleCheckbox('C4d')">C4</button>
              <input type="checkbox" id="C4d" name="C4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="C5d">
              <button type="button" <?php validar($C5) ?> id="C5" onclick="toggleCheckbox('C5d')">C5</button>
              <input type="checkbox" id="C5d" name="C5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="C6d">
              <button type="button" <?php validar($C6) ?> id="C6" onclick="toggleCheckbox('C6d')">C6</button>
              <input type="checkbox" id="C6d" name="C6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="D1d">
              ...
              <input type="checkbox" id="D1d" name="D1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="D2d">
              <button type="button" <?php validar($D2) ?> id="D2" onclick="toggleCheckbox('D2d')">D2</button>
              <input type="checkbox" id="D2d" name="D2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="D3d">
              ...
              <input type="checkbox" id="D3d" name="D3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="D4d">
              <button type="button" <?php validar($D4) ?> id="D4" onclick="toggleCheckbox('D4d')">D4</button>
              <input type="checkbox" id="D4d" name="D4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="D5d">
              <button type="button" <?php validar($D5) ?> id="D5" onclick="toggleCheckbox('D5d')">D5</button>
              <input type="checkbox" id="D5d" name="D5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="D6d">
              <button type="button" <?php validar($D6) ?> id="D6" onclick="toggleCheckbox('D6d')">D6</button>
              <input type="checkbox" id="D6d" name="D6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="E1d">
              ...
              <input type="checkbox" id="E1d" name="E1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="E2d">
              <button type="button" <?php validar($E2) ?> id="E2" onclick="toggleCheckbox('E2d')">E2</button>
              <input type="checkbox" id="E2d" name="E2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="E3d">
              ...
              <input type="checkbox" id="E3d" name="E3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="E4d">
              <button type="button" <?php validar($E4) ?> id="E4" onclick="toggleCheckbox('E4d')">E4</button>
              <input type="checkbox" id="E4d" name="E4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="E5d">
              <button type="button" <?php validar($E5) ?> id="E5" onclick="toggleCheckbox('E5d')">E5</button>
              <input type="checkbox" id="E5d" name="E5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="E6d">
              <button type="button" <?php validar($E6) ?> id="E6" onclick="toggleCheckbox('E6d')">E6</button>
              <input type="checkbox" id="E6d" name="E6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="F1d">
              ...
              <input type="checkbox" id="F1d" name="F1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="F2d">
              <button type="button" <?php validar($F2) ?> id="F2" onclick="toggleCheckbox('F2d')">F2</button>
              <input type="checkbox" id="F2d" name="F2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="F3d">
              ...
              <input type="checkbox" id="F3d" name="F3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="F4d">
              <button type="button" <?php validar($F4) ?> id="F4" onclick="toggleCheckbox('F4d')">F4</button>
              <input type="checkbox" id="F4d" name="F4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="F5d">
              <button type="button" <?php validar($F5) ?> id="F5" onclick="toggleCheckbox('F5d')">F5</button>
              <input type="checkbox" id="F5d" name="F5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="F6d">
              <button type="button" <?php validar($F6) ?> id="F6" onclick="toggleCheckbox('F6d')">F6</button>
              <input type="checkbox" id="F6d" name="F6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="G1d">
              ...
              <input type="checkbox" id="G1d" name="G1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="G2d">
              <button type="button" <?php validar($G2) ?> id="G2" onclick="toggleCheckbox('G2d')">G2</button>
              <input type="checkbox" id="G2d" name="G2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="G3d">
              ...
              <input type="checkbox" id="G3d" name="G3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="G4d">
              <button type="button" <?php validar($G4) ?> id="G4" onclick="toggleCheckbox('G4d')">G4</button>
              <input type="checkbox" id="G4d" name="G4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="G5d">
              <button type="button" <?php validar($G5) ?> id="G5" onclick="toggleCheckbox('G5d')">G5</button>
              <input type="checkbox" id="G5d" name="G5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="G6d">
              <button type="button" <?php validar($G6) ?> id="G6" onclick="toggleCheckbox('G6d')">G6</button>
              <input type="checkbox" id="G6d" name="G6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="H1d">
              ...
              <input type="checkbox" id="H1d" name="H1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="H2d">
              <button type="button" <?php validar($H2) ?> id="H2" onclick="toggleCheckbox('H2d')">H2</button>
              <input type="checkbox" id="H2d" name="H2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="H3d">
              ...
              <input type="checkbox" id="H3d" name="H3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="H4d">
              <button type="button" <?php validar($H4) ?> id="H4" onclick="toggleCheckbox('H4d')">H4</button>
              <input type="checkbox" id="H4d" name="H4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="H5d">
              <button type="button" <?php validar($H5) ?> id="H5" onclick="toggleCheckbox('H5d')">H5</button>
              <input type="checkbox" id="H5d" name="H5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="H6d">
              <button type="button" <?php validar($H6) ?> id="H6" onclick="toggleCheckbox('H6d')">H6</button>
              <input type="checkbox" id="H6d" name="H6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="I1d">
              ...
              <input type="checkbox" id="I1d" name="I1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="I2d">
              <button type="button" <?php validar($I2) ?> id="I2" onclick="toggleCheckbox('I2d')">I2</button>
              <input type="checkbox" id="I2d" name="I2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="I3d">
              ...
              <input type="checkbox" id="I3d" name="I3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="I4d">
              <button type="button" <?php validar($I4) ?> id="I4" onclick="toggleCheckbox('I4d')">I4</button>
              <input type="checkbox" id="I4d" name="I4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="I5d">
              <button type="button" <?php validar($I5) ?> id="I5" onclick="toggleCheckbox('I5d')">I5</button>
              <input type="checkbox" id="I5d" name="I5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="I6d">
              <button type="button" <?php validar($I6) ?> id="I6" onclick="toggleCheckbox('I6d')">I6</button>
              <input type="checkbox" id="I6d" name="I6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="J1d">
              ...
              <input type="checkbox" id="J1d" name="J1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="J2d">
              <button type="button" <?php validar($J2) ?> id="J2" onclick="toggleCheckbox('J2d')">J2</button>
              <input type="checkbox" id="J2d" name="J2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="J3d">
              ...
              <input type="checkbox" id="J3d" name="J3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="J4d">
              <button type="button" <?php validar($J4) ?> id="J4" onclick="toggleCheckbox('J4d')">J4</button>
              <input type="checkbox" id="J4d" name="J4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="J5d">
              <button type="button" <?php validar($J5) ?> id="J5" onclick="toggleCheckbox('J5d')">J5</button>
              <input type="checkbox" id="J5d" name="J5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="J6d">
              <button type="button" <?php validar($J6) ?> id="J6" onclick="toggleCheckbox('J6d')">J6</button>
              <input type="checkbox" id="J6d" name="J6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
        ...
        <div class="row justify-content-center row-spacing">
          ...
          <div class="seat-group">
            <label for="K1d">
              ...
              <input type="checkbox" id="K1d" name="K1" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="K2d">
              <button type="button" <?php validar($K2) ?> id="K2" onclick="toggleCheckbox('K2d')">K2</button>
              <input type="checkbox" id="K2d" name="K2" value="ocupado" class="hola">
            </label>
          </div>
          ...
          <div class="seat-group">
            <label for="K3d">
              ...
              <input type="checkbox" id="K3d" name="K3" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="K4d">
              <button type="button" <?php validar($K4) ?> id="K4" onclick="toggleCheckbox('K4d')">K4</button>
              <input type="checkbox" id="K4d" name="K4" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="K5d">
              <button type="button" <?php validar($K5) ?> id="K5" onclick="toggleCheckbox('K5d')">K5</button>
              <input type="checkbox" id="K5d" name="K5" value="ocupado" class="hola">
            </label>
          </div>
          <div class="seat-group">
            <label for="K6d">
              <button type="button" <?php validar($K6) ?> id="K6" onclick="toggleCheckbox('K6d')">K6</button>
              <input type="checkbox" id="K6d" name="K6" value="ocupado" class="hola">
            </label>
          </div>
        </div>
      </div>
