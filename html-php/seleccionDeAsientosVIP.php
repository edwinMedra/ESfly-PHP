...
<body>
  <div class="container">
    <div class="text-center">
      <div class="titulo">
        <div class="titulo-1"><h4>ASIENTOS ESPECIALES</h4></div>
...
<div class="row justify-content-center row-spacing">
  ...
  <div class="seat-group">
    ...
    <input type="checkbox" id="A3d" name="A3" class="d-none">
    </label>
  </div>
  <div class="seat-group">
    <label for="A4d">
    <div class="seat" id="A4">A4</div>
    <input type="checkbox" id="A4d" name="A4" class="d-none">
    </label>
  </div>
  ...
  <div class="seat-group">
    ...
    <input type="checkbox" id="A5d" name="A5" class="d-none">
    </label>
  </div>
  <div class="seat-group">
    <label for="A6d">
    <div class="seat" id="A6">A6</div>
    <input type="checkbox" id="A6d" name="A6" class="d-none">
    </label>
  </div>
</div>
<div class="row justify-content-center row-spacing">
...
<button class="reserve-button" onclick="reserveSeats()" name="reserva">Reservar</button>
</div>
</form>
...
if (isset($_POST['reserva'])){
  ...
  if ($A1 == null || $A1 = ""){
    ...
    $A1 = "A1";
    $insert = "UPDATE asientos SET A1='ocupado' where idVuelo='$idvuelo'";
    $insert1 = "UPDATE asientos SET destino='$destino' where idVuelo='$idvuelo'";
    $insert2 = "UPDATE asientos SET idCliente='$idCliente' where idVuelo='$idvuelo'";
    $consul = mysqli_query($conexion,$insert);
    $consul1 = mysqli_query($conexion,$insert1);  
    $consul2 = mysqli_query($conexion,$insert2);  
    if ($consul){
  ...
  ////
    ...
    if ($A2 == null || $A2 = ""){
      ...
      $A2 = "A2";
      $insert = "UPDATE asientos SET A2='ocupado' where idVuelo='$idvuelo'";
      $insert1 = "UPDATE asientos SET destino='$destino' where idVuelo='$idvuelo'";
      $insert2 = "UPDATE asientos SET idCliente='$idCliente' where idVuelo='$idvuelo'";
    $consul = mysqli_query($conexion,$insert);
    $consul1 = mysqli_query($conexion,$insert1);  
    ...
    ////
        ...
        if ($A3 == null || $A3 = ""){
          ...
          $A3 = "A3";
          $insert = "UPDATE asientos SET A3='ocupado' where idVuelo='$idvuelo'";
          $insert1 = "UPDATE asientos SET destino='$destino' where idVuelo='$idvuelo'";
          $insert2 = "UPDATE asientos SET idCliente='$idCliente' where idVuelo='$idvuelo'";
        $consul = mysqli_query($conexion,$insert);
        $consul1 = mysqli_query($conexion,$insert1);  
    ...
    if ($A4 == null || $A4 = ""){
      ...
      $A4 = "A4";
      $insert = "UPDATE asientos SET A4='ocupado' where idVuelo='$idvuelo'";
      $insert1 = "UPDATE asientos SET destino='$destino' where idVuelo='$idvuelo'";
      $insert2 = "UPDATE asientos SET idCliente='$idCliente' where idVuelo='$idvuelo'";
    $consul = mysqli_query($conexion,$insert);
    $consul1 = mysqli_query($conexion,$insert1);  
    ...
    ////
        ...
        if ($A5 == null || $A5 = ""){
          ...
          $A5 = "A5";
          $insert = "UPDATE asientos SET A5='ocupado' where idVuelo='$idvuelo'";
          $insert1 = "UPDATE asientos SET destino='$destino' where idVuelo='$idvuelo'";
          $insert2 = "UPDATE asientos SET idCliente='$idCliente' where idVuelo='$idvuelo'";
        $consul = mysqli_query($conexion,$insert);
        $consul1 = mysqli_query($conexion,$insert1);
    ...
    if ($A6 == null || $A6 = ""){
      ...
      $A6 = "A6";
      $insert = "UPDATE asientos SET A6='ocupado' where idVuelo='$idvuelo'";
      $insert1 = "UPDATE asientos SET destino='$destino' where idVuelo='$idvuelo'";
      $insert2 = "UPDATE asientos SET idCliente='$idCliente' where idVuelo='$idvuelo'";
    $consul = mysqli_query($conexion,$insert);
    $consul1 = mysqli_query($conexion,$insert1);  
