...
<body>
    ...
    ?>
    <div class="container-fluid w-75 rounded-1">
        <div class="row">
            <div class="col-lg-12 col-12 border border-black text-center" id="usuT">
                <h5>USUARIOS</h5>
            </div>
            ...
            <div class="col-lg-1  col-12 border border-black text-center"><b>Correo</b></div>
            <div class="col-lg-2  col-12 border border-black text-center"><b>Pasaporte</b></div>
