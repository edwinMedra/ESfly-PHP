...
<head>
    ...
    <style>
        ...
        .dropdown-menu {
            position: absolute; 
            top: 80px; /* Ajusta este valor para que se alinee justo debajo de la imagen */
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-navbar fixed-top">
        <div class="container-fluid">    
            <a class="navbar-brand" href="inicioEmpleado.php">
                <img src="../imagen/estoyAnsioso/esflyInfo.png" id="logo" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <form class="d-flex" role="search">
                    ...
                    ?>
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="../imagen/header_ayudante/logo_usuario.png" class="rounded-circle border border-1 border-black mx-1" alt="" height="35px" width="35px">
                        </a>
                    <?php
                    } else {
                    ?>
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="data:image/jpg;base64,<?php echo base64_encode($foto) ?>" class="rounded-circle border border-1 border-black mx-1" alt="" height="35px" width="35px" style="object-fit: cover;">
                        </a>
                    <?php
                    }
                    ?>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item fijo">¡Hola, <?php echo $nombre ?>!</a></li>
                        <hr>
                ...
                <button class="btn ms-1" type="button" id="search-btn">
                    <img src="../imagen/header/lupa.png" id="lupa" alt="" width="20"> Buscar
                </button>
            </div>
        </div>
    </nav>
